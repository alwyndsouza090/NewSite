...
import jet from '../../Images/slabs/Jet Black.jpg'
...
const Jet = () => {
  return (
    ...
    <Topbar/>
    <Mainbar/>
    <div style={{width:'100%',height:'15%',backgroundColor:'whitesmoke'}} className='text-center'><h3 className='h3' style={{color:'brown',fontSize:'bold',fontFamily:'sans-serif'}}>JET BLACK</h3></div>
...
<div className='container'>
  ...
  <Item
    ...
    >
      {({ ref, open }) => (
        <img ref={ref} onClick={open} alt='' src={jet}  style={{height:'300px',width:'500px',margin:'10px'}} />
      )}
    </Item>
    </Gallery>
  </div>
